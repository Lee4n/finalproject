...
function BookSearch( props) {
  return (
    <div className="container clearfix shadow-lg p-3 mb-5 bg-white rounded">
      <h5>Duty Station Search</h5>
      <div className="input-group mb-3">
        <input type="text" onChange={props.handleChange}  className="form-control" name="search" value={props.search} placeholder="Search for a Duty Station..."/>
